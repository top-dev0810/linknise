    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#10182a]">
            ...
            >
                ...
                <p className="text-gray-400 text-center mb-2">Enter your email, reset code, and new password.</p>
                {success && <div className="text-green-500 text-sm font-semibold w-full text-center">Password reset successful! You can now sign in.</div>}
